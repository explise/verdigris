...
- **Be excellent to each other.** See [`CODE_OF_CONDUCT.md`](https://github.com/explise/verdigris/blob/main/.github/CODE_OF_CONDUCT.md).
...
scale is testable in seconds. See [Testing (DST)](dst-architecture.md).
...
- Update the relevant status doc (`web/STATUS.md`, the FAQ's status section) and any ADR when you
  change architecture or the API contract.

## Decision records (ADRs)

Architecturally significant decisions are recorded in [`docs/adr/`](adr/README.md). If your
...
[`frontend/AGENTS.md`](https://github.com/explise/verdigris/blob/main/frontend/AGENTS.md) and [`web/STATUS.md`](https://github.com/explise/verdigris/blob/main/web/STATUS.md) first — the backend
